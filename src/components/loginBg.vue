...
export default {
    props: {
      ...
      lineColor: {
        type: String,
        default: 'rgb(254, 255, 255)'//'rgba(45,140,210,0.2)' // 线的颜色
      },
      roundColor: {
        type: String,
        default: '#315ad8' // 星星的颜色
      },
    },
    data() {
      return {
        ...
        circleArr: [], // 圆点数组
        timer: null, // 定时器对象
        colorElementArr: ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'a', 'b', 'c', 'd', 'e', 'f']
      }
    },
    mounted() {
      ...
      this.context.fillStyle = this.roundColor;// this.randomColor();//
    ...
    methods: {
      randomColor () {
        let result = '#'
        for (let i=0; i<6; i++) {
          result += this.colorElementArr[this.random(15, 0)]
        }
        console.log(result)
        return result
      },

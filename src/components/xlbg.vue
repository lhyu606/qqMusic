<template>
<div class="mask">
	<div class="home-banner" style="zoom: 0.8;"> <div class="home-banner__wp"> <div class="xl-pro-banner"> <ul class="banner-list"> <li class="banner__item item01 j_banner_1"> <div class="home-banner__box"> <i class="banner-earth banner-earth01"></i> <div class="banner-detail" style="
    display:  none;
"> <a class="banner-detail__logo j_icon j_maidian" href="http://x.xunlei.com/" target="_blank" data-maidian-cg="page_go" data-maidian-at="xlx_home_go" data-maidian-ed="{&quot;button&quot;:&quot;logo&quot;}"> <i class="banner-detail__logo02"></i> </a> <h3 class="banner-detail__tit"> <a class="j_title j_maidian" href="http://x.xunlei.com/" target="_blank" data-maidian-cg="page_go" data-maidian-at="xlx_home_go" data-maidian-ed="{&quot;button&quot;:&quot;title&quot;}">迅雷X</a> </h3> <p class="j_desc banner-detail__info">精彩，一下就有</p> <a class="banner-detail__btn j_button_url j_maidian" href="http://down.sandai.net/thunderx/XunLeiWebSetup10.1.21.540gw.exe" role="button" data-maidian-cg="download" data-maidian-at="xlx_download" data-maidian-ed="{&quot;button&quot;:&quot;detail&quot;}"> <i class="box"></i> <i class="mask"></i> <i class="info j_button_text">立即下载</i> </a> </div> </div> </li> <li class="banner__item item02 j_banner_2"> <div class="home-banner__box"> <i class="banner-earth banner-earth02"></i> <div class="banner-detail"> <a class="banner-detail__logo j_icon j_maidian" href="http://video.xunlei.com/" target="_blank" data-maidian-cg="page_go" data-maidian-at="xmp_home_go" data-maidian-ed="{&quot;button&quot;:&quot;logo&quot;}"> <i class="banner-detail__logo02"></i> </a> <h3 class="banner-detail__tit"> <a class="j_title j_maidian" href="http://video.xunlei.com/" target="_blank" data-maidian-cg="page_go" data-maidian-at="xmp_home_go" data-maidian-ed="{&quot;button&quot;:&quot;title&quot;}">迅雷影音</a> </h3> <p class="banner-detail__info j_desc">视界多绮丽</p> <a class="banner-detail__btn j_button_url j_maidian" href="http://xmp.down.sandai.net/xmp/XMPSetup_5.4.6.6504-www.exe" role="button" data-maidian-cg="download" data-maidian-at="xmp_download" data-maidian-ed="{&quot;button&quot;:&quot;detail&quot;}"> <i class="box"></i> <i class="info j_button_text">立即下载</i> </a> </div> </div> </li> <li class="banner__item item03 j_banner_3"> <div class="home-banner__box"> <i class="banner-earth banner-earth03"></i> <div class="banner-detail"> <a class="banner-detail__logo j_icon j_maidian" href="https://www.onethingcloud.cn/site/prodv3.html" target="_blank" data-maidian-cg="page_go" data-maidian-at="wankeyun_home_go" data-maidian-ed="{&quot;button&quot;:&quot;logo&quot;}"> <i class="banner-detail__logo02"></i> </a> <h3 class="banner-detail__tit"> <a class="j_title j_maidian" href="https://www.onethingcloud.cn/site/prodv3.html" target="_blank" data-maidian-cg="page_go" data-maidian-at="wankeyun_home_go" data-maidian-ed="{&quot;button&quot;:&quot;title&quot;}">玩客云</a> </h3> <p class="banner-detail__info j_desc">畅快下载的私人云盘</p> <a class="banner-detail__btn j_button_url j_maidian" href="https://www.onethingcloud.cn/site/prodv3.html" role="button" target="_blank" data-maidian-cg="page_go" data-maidian-at="wankeyun_home_go" data-maidian-ed="{&quot;button&quot;:&quot;detail&quot;}"> <i class="box"></i> <i class="info j_button_text">了解详情</i> </a> </div> </div> </li> </ul> <div class="banner-line"> <i class="banner-line__circle01"></i> <i class="banner-line__circle02"></i> </div> <div class="home-banner__pathway"> <div class="banner-pathway__lite01"><i class="pathway-dec dec01"></i><i class="pathway-dec dec02"></i></div> <div class="banner-pathway__lite02"><i class="pathway-dec"></i></div> <div class="banner-pathway__lite03"></div> <div class="banner-pathway__lite04"></div> </div> <div class="home-banner__net"> <i class="home-banner__net01"></i> <i class="home-banner__net02"></i> </div> </div> <div class="home-banner__tab"> <div class="home-banner__switch"> <i class="banner-switch__line" style="display: block; transform: rotate(1.4324deg) translateZ(0px);"></i> </div> <ul class="home-banner__list" style="display: none;"> <li class="item01 cur"> <a class="banner-tab__btn" role="button"> <i class="banner-tab__ico01"></i> <i class="banner-tab__ico02"></i> <span class="j_xlxtitle">迅雷X</span> </a> </li> <li class="item02"> <a data-maidian-at="windows:xmp_download, mac:macxmp_download" data-maidian-ed="{'button': 'detail'}" class="banner-tab__btn" role="button"> <i class="banner-tab__ico01"></i> <i class="banner-tab__ico02"></i> <span>迅雷影音</span> </a> </li><!--
                                <li class="item03" >
                                    <a data-maidian-cg="page_go" data-maidian-at="wankeyun_home_go" data-maidian-ed="{'button': 'detail'}" class="banner-tab__btn" role="button">
                                        <i class="banner-tab__ico01"></i>
                                        <i class="banner-tab__ico02"></i>
                                        <span>玩客云</span>
                                    </a>
                                </li>--> </ul> </div> </div> </div>
</div>
...
/* ------ 头部 ------ */
.home-banner__wp {
    background-image: url(https://www.xunlei.com/v2018/dist/banner_bg.jpg?h=b150bd);
    background-repeat: no-repeat;
    background-position: center top;
}
.home-banner__wp .xl-pro-banner:after {
    background-image: url(https://www.xunlei.com/v2018/dist/banner_bgmask.png?h=11c08a);
    background-repeat: no-repeat;
    background-position: center top;
}

.banner-mask__box {
    background-image: url(https://www.xunlei.com/v2018/dist/banner-mask.png?h=6b6cfb);
    background-repeat: no-repeat;
    background-position: center top;
    height: 351px;
}
...
.banner-earth01 {
    background: url(https://www.xunlei.com/v2018/dist/earth01.png?h=9bbded) no-repeat;
    width: 730px;
    height: 730px;
}
.banner-earth02 {
    background: url(https://www.xunlei.com/v2018/dist/earth02.png?h=10e885) no-repeat;
    width: 730px;
    height: 730px;
}
.banner-earth03 {
    background: url(https://www.xunlei.com/v2018/dist/earth03.png?h=ab2f78) no-repeat;
    width: 730px;
    height: 730px;
}

.banner-line__circle01 {
    background-image:url(https://www.xunlei.com/v2018/dist/spr_bannerPathway.png?h=2a666c);
...
.home-banner__list .item01 .banner-tab__ico01 {
    background-image:url(https://www.xunlei.com/v2018/dist/spr_bannerTab.png?h=1012f7);
...
.banner-pathway__lite01 .pathway-dec.dec01 {
    background-image:url(https://www.xunlei.com/v2018/dist/spr_head.png?h=86a4c4);
